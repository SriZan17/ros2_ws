...
class Metaclass_JointConversion_Event(type):
    """Metaclass of message 'JointConversion_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__joint_conversion__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__joint_conversion__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__joint_conversion__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__joint_conversion__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__joint_conversion__event
...
class JointConversion_Event(metaclass=Metaclass_JointConversion_Event):
    """Message class 'JointConversion_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<srv_pkg/JointConversion_Request, 1>',
        'response': 'sequence<srv_pkg/JointConversion_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['srv_pkg', 'srv'], 'JointConversion_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['srv_pkg', 'srv'], 'JointConversion_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from srv_pkg.srv import JointConversion_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, JointConversion_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'JointConversion_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from srv_pkg.srv import JointConversion_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, JointConversion_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'JointConversion_Response'"
...
class Metaclass_JointConversion(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _joint_conversion.Metaclass_JointConversion_Event._TYPE_SUPPORT is None:
                _joint_conversion.Metaclass_JointConversion_Event.__import_type_support__()
...
class JointConversion(metaclass=Metaclass_JointConversion):
    ...
    from srv_pkg.srv._joint_conversion import JointConversion_Event as Event
