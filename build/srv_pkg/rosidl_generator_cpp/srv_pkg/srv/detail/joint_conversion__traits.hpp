...
inline void to_flow_style_yaml(
  const JointConversion_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const JointConversion_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use srv_pkg::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const srv_pkg::srv::JointConversion_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  srv_pkg::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use srv_pkg::srv::to_yaml() instead")]]
inline std::string to_yaml(const srv_pkg::srv::JointConversion_Event & msg)
{
  return srv_pkg::srv::to_yaml(msg);
}

template<>
inline const char * data_type<srv_pkg::srv::JointConversion_Event>()
{
  return "srv_pkg::srv::JointConversion_Event";
}

template<>
inline const char * name<srv_pkg::srv::JointConversion_Event>()
{
  return "srv_pkg/srv/JointConversion_Event";
}

template<>
struct has_fixed_size<srv_pkg::srv::JointConversion_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<srv_pkg::srv::JointConversion_Event>
  : std::integral_constant<bool, has_bounded_size<service_msgs::msg::ServiceEventInfo>::value && has_bounded_size<srv_pkg::srv::JointConversion_Request>::value && has_bounded_size<srv_pkg::srv::JointConversion_Response>::value> {};

template<>
struct is_message<srv_pkg::srv::JointConversion_Event>
  : std::true_type {};
