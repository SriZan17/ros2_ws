...
class Init_JointConversion_Event_response
{
public:
  explicit Init_JointConversion_Event_response(::srv_pkg::srv::JointConversion_Event & msg)
  : msg_(msg)
  {}
  ::srv_pkg::srv::JointConversion_Event response(::srv_pkg::srv::JointConversion_Event::_response_type arg)
  {
...
private:
  ::srv_pkg::srv::JointConversion_Event msg_;
};

class Init_JointConversion_Event_request
{
public:
  explicit Init_JointConversion_Event_request(::srv_pkg::srv::JointConversion_Event & msg)
  : msg_(msg)
  {}
  Init_JointConversion_Event_response request(::srv_pkg::srv::JointConversion_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_JointConversion_Event_response(msg_);
  }
...
class Init_JointConversion_Event_info
{
public:
  Init_JointConversion_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_JointConversion_Event_request info(::srv_pkg::srv::JointConversion_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_JointConversion_Event_request(msg_);
  }
...
template<>
inline
auto build<::srv_pkg::srv::JointConversion_Event>()
{
  return srv_pkg::srv::builder::Init_JointConversion_Event_info();
}
